...
| 3 | >= 30 position-changes (got 439) | PASS |

**VERDICT: PASS**

## Honest Assessment

- **Full period:** low-vol +11.0% CAGR vs NIFTY +6.8% — beat buy-and-hold after all costs.
- **Out-of-sample (Period B):** low-vol +7.3% vs NIFTY +3.9% — held up.
...
- **Activity:** 439 position-changes across 58 monthly rebalances (low-vol turnover is expected to be modest).
